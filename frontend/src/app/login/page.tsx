...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const data = await api.post<AuthUser>("/auth/login", { login, senha });
      saveAuth(data);
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">Gestão de alunos e mensalidades</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="space-y-2">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-lg px-3 py-2 text-sm hover:bg-gray-50 transition-colors"
            >
              <GoogleIcon />
              Google
            </a>
