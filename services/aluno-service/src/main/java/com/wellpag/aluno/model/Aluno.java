...
/**
 * Modelo completo — aluno-service e o dono real desta entidade/collection.
 * Aponta para a mesma collection "alunos" e mesmo banco (wellpag_dev) que o
 * monolito ainda usa em producao durante a Wave 2 (ver decisao de arquitetura
 * no README/tarefa de extracao): nao ha database-per-service de verdade ainda.
 */
@Data
