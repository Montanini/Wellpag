package com.wellpag.relatorio.service;

import com.wellpag.relatorio.dto.DashboardAlunoItem;
import com.wellpag.relatorio.model.*;
import com.wellpag.relatorio.repository.AlunoRepository;
import com.wellpag.relatorio.repository.HorarioRepository;
import com.wellpag.relatorio.repository.MensalidadeRepository;
...
public class DashboardService {
     ...
     * com status de mensalidade do mes atual.
     */
    public List<DashboardAlunoItem> listar(String professorId, DiaSemana diaSemana) {
        ...
        Map<String, Aluno> alunoMap = alunoRepository.findByIdIn(alunoIds)
            .stream()
