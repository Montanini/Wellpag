 ...
 * protegem /professor/dashboard e /professor/relatorios (role PROFESSOR), mais o
 * necessario para Swagger/actuator. Nao ha OAuth2 login nem DaoAuthenticationProvider
