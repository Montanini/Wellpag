...
/**
 * URLs base dos microsservicos ja extraidos, usadas pelo RouteConfig para
 ...
 * RouteConfig sobre a remocao da rota /webhook/**. pagamento-service (Banco
 * Inter) tambem foi removido do repositorio - ver CLAUDE.md.
 */
@Getter
@Setter
@Component
